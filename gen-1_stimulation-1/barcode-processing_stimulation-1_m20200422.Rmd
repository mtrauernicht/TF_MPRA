...
bc_df <- bc_df[!is.na(bc_df$seq),] %>% dplyr::select(-TF, -Spacing, -Distance, -Barcode,
                                                                -Promoter, -Background, -seq)
bartender_df <- bartender_df[!is.na(bartender_df$seq),]%>% dplyr::select(-TF, -Spacing, -Distance, -Barcode,
                                                                -Promoter, -Background, -seq)
