...
meta <- readRDS("/DATA/usr/t.filipovska/projects/ATAC-seq_TF-footprinting/analysis/rds/bamfile_atacseq_metadata2.rds")

peaks <- import("/DATA/usr/t.filipovska/projects/ATAC-seq_TF-footprinting/analysis/bed_peaks/20210610/6420_peaks.narrowPeak")
...
saveRDS(exp, "/DATA/usr/t.filipovska/projects/ATAC-seq_TF-footprinting/analysis/rds/experiment_6420_20210610.rds")
