...
## Visualize chosen motifs within motif clusters
```{r}
### UMAP analysis
set.seed(35425) 
motif_cor <- motif_sim %>%
...
## Scan designed reproter library - compare motif counts per reporter of synthetic vs. published reporters
Aim: Show that the designed reporters have less secondary TFBSs.

```{r}
## Load reporter library sequences
