...
```{r reporter_activities, out.width= "80%", fig.align= "center", echo=FALSE, warning= FALSE, message = FALSE}
...
for (i in unique(cDNA_df$condition)) {
  ...
  p <- ggplot_custom(cDNA_df %>%
                ...
                unique(),
            aes(x = log(reporter_activity_minP), y = -log10(pval_adj_minP),
                color = ifelse(log(reporter_activity_minP) > 1 & pval_adj_minP < 0.05, "green", 
                               ifelse(log(reporter_activity_minP) < -1 & pval_adj_minP < 0.05, "yellow","black")))) +
    geom_point() +
...
```{r reporter_fraction, out.width= "80%", fig.align= "center", echo=FALSE, warning= FALSE, message = FALSE}
...
```{r tf_activity_reporter_fraction, out.width= "80%", fig.align= "center", echo=FALSE, warning= FALSE, message = FALSE}
...
### Fit linear model to reporter classification

```{r linear_model_classes, out.width= "80%", fig.align= "center", echo=FALSE, warning= FALSE, message = FALSE}
# Sub-select relevant data
cDNA_df_lm <- cDNA_df %>%
...
```{r reporter_correlations, out.width= "80%", fig.align= "center", echo=FALSE, warning= FALSE, message = FALSE}
...
```{r reporter_selection, out.width= "80%", fig.align= "center", echo=FALSE, warning= FALSE, message = FALSE}
