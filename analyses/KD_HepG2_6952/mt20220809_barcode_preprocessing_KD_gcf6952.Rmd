...
# Import pDNA barcode counts
bc_files2 = '/DATA/usr/m.trauernicht/projects/P53_reporter_scan/data/gcf6992/raw-data-analysis/results/6992_5_E1961_pDNA_pMT02_09_GGCTTAAG-TCGATATC_S5_barcode_counts.tsv'
bc_list <- lapply(bc_files2, fread, header = FALSE)
names(bc_list)<- "E1961_pDNA"
bc_files <- c(bc_files, bc_list)
...
bc_df_cor <- bc_df_cor %>%
  filter(sample_id %in% c("pMT02_3_r1_gcf6952", "pMT02_r1_gcf6952", "pMT02_v2_r1_gcf6952", "pMT02_v3_r1_gcf6952", "pMT02-09_v2_r1_gcf6952", "pMT02-09_v3_r1_gcf6952", "E1961_pDNA")) %>%
