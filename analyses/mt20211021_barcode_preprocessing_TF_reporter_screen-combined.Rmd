...
bc_df_cor4 <- bc_df_cor %>%
  filter(library == "1+2") %>%
  dplyr::select(matches("barcode|gcf6502|gcf6881|pMT09_02_r1_gcf6578")) %>%
...
pMT09_02 <- bc_df_filt %>%
  ...
  dplyr::select(barcode, sample_id, rpm) %>%
  spread(sample_id, rpm) %>%
  mutate(pMT09_02 = (pMT09_02_r1_gcf6502 + pMT09_02_r1_gcf6578 + pMT09_02_r1_gcf6881 + pMT09_02_r2_gcf6881)/4) %>%
...
setwd("/DATA/usr/m.trauernicht/projects/SuRE-TF/data/gcf6881_gen2_all/results/")
