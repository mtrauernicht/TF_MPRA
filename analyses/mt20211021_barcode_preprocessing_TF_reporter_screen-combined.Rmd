...
metadata_df <- read_csv2("/DATA/usr/m.trauernicht/projects/SuRE-TF/analyses/mt20211025_metadata_all_experiments.csv")
...
bc_annotation <- read_csv2("/DATA/usr/m.trauernicht/projects/SuRE-TF/analyses/mt20211021_bc_annotation_combined.csv") %>%
...
p <- ggplot(bc_fraction[bc_fraction$library == i,]) +
