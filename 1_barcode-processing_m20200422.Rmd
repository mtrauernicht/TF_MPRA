...
```{r overall bc reads, out.width= "100%", fig.align= "center", echo=FALSE, warning= FALSE}
...
pDNA <- pDNA %>% select(barcode, pDNA)

pDNA_0 <- nrow(pDNA[pDNA$pDNA == 0,])
pDNA_1 <- nrow(pDNA[pDNA$pDNA != 0,])
...
# 13.2% of the TF reporters is not in the library - this is not optimal
